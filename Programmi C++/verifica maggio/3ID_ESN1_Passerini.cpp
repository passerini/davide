...
int main() {
    ...
    scanf("%f", &km);
    printf("Inserisci il costo al km: ");
    scanf("%f", &costo_km);
    ...
    printf("Vuoi l'imbarco prioritario? (1=si, 0=no): ");
    ...
    printf("Vuoi imbarcare un bagaglio in stiva? (1=si, 0=no): ");
    ...
    printf("Vuoi un biglietto flessibile? (1=si, 0=no): ");
